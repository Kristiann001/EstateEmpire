...
export default function RentedDetail() {
    ...
    return (
        <div className="relative min-h-screen bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('https://assets-news.housing.com/news/wp-content/uploads/2021/10/28230258/Best-colours-for-home-outside-shutterstock_346448522.jpg')" }}>
            <div className="flex flex-col p-4 sm:p-6 md:p-10 space-y-4 bg-white bg-opacity-80 rounded-lg shadow-md mx-4 md:mx-auto">
                <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                    ...
                    <div className="flex flex-col justify-center items-center bg-white border border-gray-200 rounded-lg shadow dark:border-gray-700 dark:bg-gray-800 w-full md:w-1/2 p-4 md:p-6">
                        <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{rental.name}</h3>
                        <p className="text-xl font-semibold mb-2">{rental.location}</p>
                        <p className="py-4 text-xl font-semibold">Ksh {formatPrice(rental.price)}</p>
                        <button
                ...
                <div className="bg-white border border-gray-200 rounded-lg shadow p-4 sm:p-6 dark:border-gray-700 dark:bg-gray-800 w-full mt-4">
                ...
                <section className="location mt-8 w-full sm:w-3/4 lg:w-2/3 mx-auto py-4">
                    <iframe
