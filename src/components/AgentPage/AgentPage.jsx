...
const AgentPage = () => {
    ...
    useEffect(() => {
        const fetchDropdownOptions = async () => {
            try {
                const response = await axios.get('https://estateempire-backend-1.onrender.com/unit_types');
        ...
        const fetchListings = async () => {
            try {
                const response = await axios.get('https://estateempire-backend-1.onrender.com/properties');
        ...
        const fetchPayments = async () => {
            try {
                const response = await axios.get('https://estateempire-backend-1.onrender.com/rental-payments');
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post(`https://estateempire-backend-1.onrender.com${endpoint}`, formData);
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`https://estateempire-backend-1.onrender.com/properties/${id}`);
